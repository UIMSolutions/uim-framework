...
void main() {
    ...
    auto sanFrancisco = new GeoJsonPoint(-122.4194, 37.7749);
    ...
    auto mountEverest = new GeoJsonPoint(86.9250, 27.9881, 8848.86);
    ...
    auto route = new GeoJsonLineString([
    ...
    auto cityPoint = new GeoJsonPoint(-122.4194, 37.7749);
    auto cityFeature = new GeoJsonFeature(cityPoint);
    ...
    auto cities = new GeoJsonFeatureCollection();
    
    // Add San Francisco
    cities.addFeature(cityFeature);
    
    // Add Los Angeles
    auto laPoint = new GeoJsonPoint(-118.2437, 34.0522);
    auto laFeature = new GeoJsonFeature(laPoint);
    ...
    // Add New York
    auto nyPoint = new GeoJsonPoint(-74.0060, 40.7128);
    auto nyFeature = new GeoJsonFeature(nyPoint);
    ...
    auto landmarks = new GeoJsonMultiPoint([
    ...
    auto islands = new GeoJsonMultiPolygon([
        [ // First island
            [
                [-122.5, 37.8],
                [-122.4, 37.8],
    ...
    auto point1 = new GeoJsonPoint(-122.4, 37.8);
    auto line1 = new GeoJsonLineString([[-122.5, 37.8], [-122.4, 37.7]]);
    auto poly1 = new GeoJsonPolygon([[
        [-122.3, 37.9],
        [-122.2, 37.9],
        [-122.2, 37.8],
        [-122.3, 37.8],
    ...
    auto collection = new GeoJsonGeometryCollection([point1, line1, poly1]);
    ...
    auto restaurants = new GeoJsonFeatureCollection();
    ...
    foreach (i, restaurant; restaurantData) {
        auto point = new GeoJsonPoint(restaurant.lon, restaurant.lat);
