...
double getDouble(Json json, string[] path, double defaultValue = 0.0) {
  ...
  return json.isFloat(path) ? json.getValue(path).getDouble : defaultValue;
}
/// 
unittest {
...
double getDouble(Json json, string key, double defaultValue = 0.0) {
  ...
  return json.isFloat(key) ? json[key].getDouble : defaultValue;
}
/// 
unittest {
...
double getDouble(Json json, size_t index, double defaultValue = 0.0) {
  ...
  return json.isFloat(index) ? json[index].getDouble : defaultValue;
}
/// 
unittest {
...
double getDouble(Json[string] map, string[] path, double defaultValue = 0.0) {
  ...
  return map.getValue(path).isFloat ? map.getValue(path).getDouble : defaultValue;
}
/// 
unittest {
...
double getDouble(Json[string] map, string key, double defaultValue = 0.0) {
  ...
  return map.getValue(key).isFloat ? map.getValue(key).getDouble : defaultValue;
}
/// 
unittest {
...
double[] getDoubles(Json[] jsons, size_t[] indices) {
  ...
  return jsons.getValues(indices, (size_t index) => jsons[index].isFloat).map!(json => json.getDouble).array;
}
///
unittest {
...
double getDouble(Json[] jsons, size_t index, double defaultValue = 0.0) {
  ...
  return jsons.getValue(index).isFloat ? jsons[index].getDouble : defaultValue;
}
/// 
unittest {
  mixin(ShowTest!"Testing getDouble for Json[] with index");
...
double[] getDoubles(Json[] jsons) {
  ...
  return jsons.filter!(json => json.isFloat).map!(json => json.getDouble).array;
}
/// 
unittest {
