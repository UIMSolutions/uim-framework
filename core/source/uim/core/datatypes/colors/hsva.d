...
// struct HSVAColor(T = float) if (isColorFloat!T) {
// 	T h;
// 	T s;
// 	T v;
// 	T a = cast(T) 1;
...
// 	HSVAColor!T normalized() const pure nothrow {
// 		T normalizedHue = h;
...
// 		return HSVAColor!T(normalizedHue, clamp01(s), clamp01(v), clamp01(a));
// 	}

// 	RGBAColor!T toRGBA() const pure nothrow {
// 		const c = normalized();
...
// 		const m = c.v - chroma;
// 		return RGBAColor!T(r1 + m, g1 + m, b1 + m, c.a);
// 	}
// }

// alias HSVAColorf = HSVAColor!float;
// alias HSVAColord = HSVAColor!double;