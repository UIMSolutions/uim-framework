...
See the `examples/`plists directory for complete examples:

- `examples/plists/basic_plist.d` - Basic property list operations
- `examples/plists/xml_plist.d` - XML format handling
- `examples/plists/nested_plist.d` - Working with nested structures
